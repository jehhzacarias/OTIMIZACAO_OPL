//Trabalho de Introducao a Otimizacao realizado por Artur Cunha, Harrison de Lana e Jessica Zacarias
//Tupla
tuple Aresta {
	int ori;   //Origem
	int che;   //Chegada
...
//Funcao objetivo 1
minimize
 sum (i in H)(zi[i]) + (alpha * sum (a in A)(dij[a.ori][a.che] * yij[a.ori][a.che])); //minimizar a quantidade de monitores necessarios 
